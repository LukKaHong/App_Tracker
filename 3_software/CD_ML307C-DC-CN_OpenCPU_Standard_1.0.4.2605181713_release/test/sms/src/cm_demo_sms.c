...
void cm_sendmsg_test_txt(unsigned char **cmd,int len)
{
    ...
    // cm_sms_send_txt("4E2D79FB6A217EC4", "10086xxxxxx",  CM_MSG_MODE_GSM_UCS2, CM_SIM_ID_0);//SIM0卡发送txt格式GSM UCS2编码短信 中移模组
}

//发送pdu格式短信
void cm_sendmsg_test_pdu(unsigned char **cmd,int len)
{
    cm_sms_send_pdu("0891683108200305F001000D91683126388788F800000B7AF4DB7DCEA7DB6F7D1D", "24", CM_MSG_MODE_GSM_7, CM_SIM_ID_0);//SIM0卡发送PDU格式GSM7编码短信 zhongyimozu
    // cm_sms_send_pdu("0881683108200305F021000D91683126388788F80008084E2D79FB6A217EC4", "22", CM_MSG_MODE_GSM_UCS2, CM_SIM_ID_0);//SIM0卡发送PDU格式GSM UCS2编码短信 中移模组
}
