...
extern bool __list_add_valid(struct list_head* new_entry,
                             struct list_head* prev,
                             struct list_head* next);
extern bool __list_del_entry_valid(struct list_head* entry);
#else
static inline bool __list_add_valid(struct list_head* new_entry,
                                           struct list_head* prev,
                                           struct list_head* next)
{
    return true;
 ...
 * @member:	the name of the hlist_node within the struct.
 */
#define hlist_for_each_entry_continue(type, pos, member)           \
 ...
 * @member:	the name of the hlist_node within the struct.
 */
#define hlist_for_each_entry_from(type, pos, member) \
    for (; pos;                                      \
         pos = hlist_entry_safe((pos)->member.next, type, member))
 ...
 * @member:	the name of the hlist_node within the struct.
 */
#define hlist_for_each_entry_safe(type, pos, n, head, member) \
    for (pos = hlist_entry_safe((head)->first, type, member); \
