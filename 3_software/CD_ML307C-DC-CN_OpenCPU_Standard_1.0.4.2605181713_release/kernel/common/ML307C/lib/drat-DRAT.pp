...
//PPL Source File Name : X:\tavor\Arbel\obj_PMD2NONE\prepass_results\modem_mgr.ppp
//PPL Source File Name : X:\\drat\\MODEM_MGR\\src\\modem_mgr.c
...
typedef UINT8 DtcF8F9Select ;
typedef UINT8 DtcDirection ;
typedef UINT8 DtcChainEndEvent ;
typedef UINT8 DtcPriority ;
typedef UINT8 DtcBlockingMode ;
typedef UINT8 DtcModeSelect ;
typedef UINT8 cipherType_te ;
//ICAT EXPORTED ENUM 
 enum 
 {	 
...
//ICAT EXPORTED STRUCT 
 typedef struct UdtcF8DescriptorTag 
 {	 
 struct UdtcF8DescriptorTag *next_p ;	 
 UINT8 *srcData_p ;	 
 UINT8 *dstData_p ;	 
 UINT16 bitLength ;	 
 UINT8 bearer ;	 
...
//ICAT EXPORTED STRUCT 
 typedef struct UdtcF9DescriptorTag 
 {	 
 UINT32 reserved0 ;	 
 UINT8 *srcData_p ;	 
 UINT32 bitLength ;	 
...
//ICAT EXPORTED STRUCT 
 typedef struct dtcTransferEndTag 
 {	 
 UINT32 status ;	 
 UINT32 macIF9Result ;	 
 UINT32 requestID ;	 
...
//ICAT EXPORTED STRUCT 
 typedef struct LteDtcDesTag 
 {	 
 struct LteDtcDesTag *next ; // pointer to the next description	 
 Int8 *dataPtr ; // Pointer to the source data address	 
 Int8 *des_addr ; // Pointer to the destination data address	 
 Int16 dataBitLen ;	 
 Int16 shareBufPara ; // include Algorithom , Retain Cipher State , Cipher Bypass , RB ID , Bcontinued , Cipher Offset and isSrb ( for RLC mask 0x0800 )	 
 Int32 headerAndFresh ; // include HDR size and Header Data	 
 Int32 bitOffset ; // include input bit offset and output bit offset	 
 Int32 count ;	 
 Int8 *key_addr ;	 
 } LteDtcDes;

typedef void ( *dtcTransferEndCallback ) ( dtcTransferEnd_ts * ) ;
//ICAT EXPORTED STRUCT 
 typedef struct dtcTransferReqTag 
 {	 
 DtcF8F9Select select ;	 
 DtcChainEndEvent cee ;	 
 DtcPriority priority ;	 
 DtcBlockingMode blockingMode ;	 
 DtcDirection dir ;	 
 // #if defined ( L1_UPGRADE_R7 )	 
 ...
 // #endif	 
 UINT32 requestID ;	 
 void *firstDescriptor_p ;	 
 dtcTransferEndCallback callback ;	 
 } dtcTransferReq_ts;

typedef UINT8 DtcSpyReqStatus ;
//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 DtcF8F9Select select ;	 
...
typedef UINT32 DataBuff [ 0x1234 ] ;
//ICAT EXPORTED ENUM 
...
//ICAT EXPORTED STRUCT 
 ...
 // [ 4 ] is for number of Tx burst: 0 : 1 st Tx ; 1 : 2 nd Tx ; 2 : 3 rd Tx ; 3 : 4 th Tx ;	 
...
//ICAT EXPORTED STRUCT 
 ...
 UINT8 bandComList [ 16 ] ; // the supported band combination , defined in 25.101000 :	 
...
//ICAT EXPORTED STRUCT 
 ...
 // [ 2 ] is for modulation: 0 : GMSK ; 1 : EPSK.	 
 // [ 4 ] is for number of Tx burst: 0 : 1 Tx ; 1 : 2 Tx ; 2 : 3 Tx ; 3 : 4 Tx ;	 
...
//ICAT EXPORTED STRUCT 
 ...
 STRUCT_FREQOFFSET_INF FreqOffInf [ 161 ] ;	 
 STRUCT_POLY_STATE PolyState ;	 
 UINT32 V2TTable [ 161 ] ; // Index is Temp+40 , Value is VTOut Descending order	 
 UINT16 Reserved2 ;	 
 } STRUCT_TSXCTRL_DB;
...
//ICAT EXPORTED STRUCT 
 ...
 unsigned char day ; // date of month: 1 ~31	 
 } DcxoCalander_ts;
...
//ICAT EXPORTED STRUCT 
 ...
 signed short dcxoAfcDacTempCompenVal ; /* the temperature comensation delta DAC value for the calibrated AFC DAC */	 
 // UINT16 updateCount ;	 
 // Bool updatedFlag ;	 
 unsigned short TemperatureDac ;	 
...
//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 unsigned char Valid ; // 1 -DB valid , otherwise invalid	 
...
//ICAT EXPORTED STRUCT 
 ...
 {	 
 unsigned short useExternalTemp ; // 0 --internal , 1 --external	 
 unsigned short dcxoCalibTemp ; /* the temperature in calibration*/	 
 unsigned short dcxoCalibTempDac ;	 
 unsigned short dcxoCalibCoarseValue ; /* Coarse value */	 
 signed long dcxoCalibMultiplier ;	 
 signed long dcxoCalibDivisor ;	 
 signed short dcxoCalibNominalDac ; /* DAC value */	 
 signed long dcxoCalibMinInputDac ; // DAC value /	 
 signed long dcxoCalibMaxInputDac ; // DAC value /	 
 signed short frqOffsetForcoarse64 ; // 0.100000 ppm	 
 DcxoAfcDacTempComp_ts dcxoAfcDacTempCompenLut [ 126 ] ;	 
 UINT32 Reserved ;	 
 TsxCalibrationParam_ts TsxCaliParam ;	 
 signed short dcxoMinCompenTemp ; /* MIN temperature value that compensated in LUT */	 
 signed short dcxoMaxCompenTemp ; /* MAX temperature value that compensated in LUT */	 
 unsigned char dcxoTempCompenStep ; /* temperature compensation step in LUT , in degree C format*/	 
...
//ICAT EXPORTED STRUCT 
 ...
 {	 
 DcxoAfcDacTempComp_ts dcxoAfcDacTempCompenLut [ 146 ] ;	 
 signed short dcxoMinCompenTemp ; /* MIN temperature value that compensated in LUT */	 
 signed short dcxoMaxCompenTemp ; /* MAX temperature value that compensated in LUT */	 
 unsigned char dcxoTempCompenStep ; /* temperature compensation step in LUT , in degree C format*/	 
...
//ICAT EXPORTED STRUCT 
 ...
 {	 
 DcxoAfcDacTempCompCustomer_ts dcxoAfcDacTempCompenLut [ 50 ] ;	 
 signed short dcxoMinCompenTemp ; /* MIN temperature value that compensated in LUT */	 
 signed short dcxoMaxCompenTemp ; /* MAX temperature value that compensated in LUT */	 
 unsigned char dcxoTempCompenStep ; /* temperature compensation step in LUT , in degree C format*/	 
 unsigned short useExternalTemp ; // 0 --internal , 1 --external	 
...
//ICAT EXPORTED STRUCT 
 ...
 unsigned short statisticsResolution ;	 
 ...
 signed short initSyncBsicRssiThr ;	 
 unsigned char cipherEngineOddIntEnable ;	 
 unsigned char GplcMipsStatsEnable ;	 
	 
 unsigned char BandLockEnable ;	 
 Band LockedBand ;	 
 unsigned char CellLockEnable ;	 
 unsigned char reserved_not_used ; // for alignment purposes - new ACAT does not open it if misaligned!	 
	 
 Arfcn LockedCell ;	 
 unsigned char reserved_not_used2 [ 2 ] ; // for alignment purposes - new ACAT does not open it if misaligned!	 
	 
 unsigned short RfDcxoIsUsingFlg ;	 
...
//ICAT EXPORTED FUNCTION_FILTER_DUMMY - MODEM_MGR , AM , plAplpVersionPrint 
 void plAplpVersionPrint ( void ) 
 {	 
 static BOOL versionInit = 0 ;	 
 ...
 // char L1rf [ 32 ] = { 0 } ;		 
 versionInit = 1 ;		 
 // Add to the label string , type of build ( full , WGDR ( wb only ) , GERAN ( gsm only ) , and RF type data		 
 ...
 // in case we have a string allocated , we build the full version in one string to help validation.		 
 // DO NOT CHNAGE this string - used by L1 validation to process data of the build automatically		 
 sprintf ( verstr , " APLP %s , Build: %s " , L1Version , L1build ) ;		 
		 
 }	 
	 
 // modified by xqshi to compile temp	 
 /*	 
 #if !defined ( GPLC_ONLY )	 
 RspGet3GCalibrationStatus ( ) ;	 
 #endif	 
 */	 
 // modified end	 
	 
 /* xiaoke remove DATE&TIME for SDK delta patch auto diff	 
 DIAG_FILTER ( APLP , AML , RELEASE_DATE , DIAG_INFORMATION )	 
 diagPrintf ( " Release creation date: %s and time: %s " , __DATE__ , __TIME__ ) ;	 
 */	 
	 
	 
 }

DIAG_FILTER ( BOOT , BOOT_TASK , wirelessModemSubsysPhase2Init_1 , DIAG_INFORMATION)  
 diagPrintf ( " wirelessModemSubsysPhase2Init is called " );

DIAG_FILTER ( BOOT , BOOT_TASK , wirelessModemSubsysPhase2Init_2 , DIAG_INFORMATION)  
 diagPrintf ( " L1CTDDebug wirelessModemSubsysPhase2Init is finished " );

//ICAT EXPORTED FUNCTION_FILTER_DUMMY - SYSTEM , L1INIT , IsL1Ready 
 void IsL1Ready ( void ) 
 {	 
 if ( l1_L1InitDone )	 
 {		 
DIAG_FILTER ( L1 , L1INIT , L1_READY , DIAG_INFORMATION)  
 diagTextPrintf ( " L1 is ready... " );

		 
 }	 
 else	 
 {		 
DIAG_FILTER ( L1 , L1INIT , L1_NOT_READY , DIAG_INFORMATION)  
 diagTextPrintf ( " L1 is NOT ready yet " );
...
//PPC Version : V2.1.9.30
//PPL Source File Name : X:\tavor\Arbel\obj_PMD2NONE\prepass_results\wgi_bind.ppp
//PPL Source File Name : X:\\drat\\GSM_IF\\src\\wgi_bind.c
typedef unsigned char BOOL ;
typedef unsigned char UINT8 ;
typedef unsigned short UINT16 ;
typedef unsigned long UINT32 ;
...
typedef unsigned short UINT16 ;
typedef unsigned char UINT8 ;
typedef Int16 L1RssiScore ;
//ICAT EXPORTED ENUM 
 typedef enum 
 {	 
 // FDD BANDS	 
 PLE_EUTRA_FIRST_FDD_BAND = 0 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_1 = PLE_EUTRA_FIRST_FDD_BAND ,	 
 PLE_EUTRA_CARRIER_LTEBAND_2 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_3 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_4 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_5 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_6 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_7 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_8 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_9 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_10 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_11 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_12 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_13 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_14 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_17 = 16 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_18 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_19 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_20 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_21 ,	 
 // TDD BANDS	 
 PLE_EUTRA_FIRST_TDD_BAND = 32 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_33 = PLE_EUTRA_FIRST_TDD_BAND ,	 
 PLE_EUTRA_CARRIER_LTEBAND_34 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_35 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_36 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_37 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_38 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_39 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_40 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_41 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_42 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_43 ,	 
 PLE_EUTRA_CARRIER_LTEBAND_44 ,	 
 PLE_EUTRA_CARRIER_NUM_OF_SUPPORTED_BANDS ,	 
 PLE_EUTRA_INVALID_BAND = PLE_EUTRA_CARRIER_NUM_OF_SUPPORTED_BANDS	 
 } PleEutraCarrierBand_te_enum;

typedef UINT8 PleEutraCarrierBand_te ;
//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 Boolean gsmScoreReq ; /**< GSM Scores Request. When TRUE , the RSSI Scan procedure report GSM RSSI on all requested frequencys. */	 
 Boolean wbScoreReq ; /**< WB Scores Request. When TRUE , the RSSI Scan procedure report WB scores on all requested frequencys. */	 
 UINT8 lteScoreReq ; /**< lteScoreReq [ 0 ] - When TRUE , scanning of LTE with BW = 1.400000 MHz is required.	 
	 
 * If FALSE , scanning is not required. lteScoreReq [ 5 ] - When TRUE , scanning of LTE with BW = 20 MHz	 
 * is required. If FALSE , scanning is not required. */	 
 Int8 bandNum ; /**< Band number , as defined 36.101000 .	 
 * In " List Mode " it is per frequency.	 
 * In " Range Mode " only first entry is used for the entire range. */	 
 UINT16 frequency ; /**< Frequency represented as 10 x Frequency in MHz. In " Range Mode " - first entry is the start	 
 * frequency in MHz and the second entry is the stop frequency in MHz. The start frequency represents	 
...
//ICAT EXPORTED ENUM 
 ...
 UMTS_RAT ,	 
 EUTRA_RAT ,	 
 } plmRssiScanRat_te_enum;

typedef UINT8 plmRssiScanRat_te ;
//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
	 
 plmRssiScanRat_te rat ; /* indicate which RAT request the RssiScanReq */ /*CQ00071284 */	 
 Boolean bgInd ; /*Indicates if the RSSI Scan is BG or FG operation.*/	 
 Boolean listIndication ; /**< frequency list indication. When TRUE , the frequencys that are need to be scanned are in given by	 
 * the list in earfcnList field. When FALSE , the frequencys to be scanned are indicated by startfrq	 
 * and endfrq fields. */	 
 UINT16 numOfFreqs ; /**< In " Range Mode " this number is always 2 .	 
 In " List Mode " the number represents the number of EARFCNs in the list. Maximum number of EARFCNs is 32 .*/	 
	 
 plmRssiScanFreqList_ts freqList [ ( 32 ) ] ; /** < In " Range Mode " - first entry is the start frequency in MHz and the second	 
 * entry is the stop frequency in MHz. In " List Mode " - each entry represent the frequency in MHz to be search for*/	 
	 
 PleLteResultsTableElement_ts *lteResult_p ; /**< Lte Pointer to the results in the shared memory */	 
 L1RssiScore *wbResult_p ; /**< WB Pointer to the results in the shared memory */	 
 L1RssiScore *gsmResult_p ; /**< GSM Pointer to the results in the shared memory */	 
 } plmRssiScanReq_ts;

//ICAT EXPORTED ENUM 
 typedef enum 
 {	 
 RSSI_SCAN_CNF_NO_ERRORS = 0 ,	 
 RSSI_SCAN_CNF_UL1_TIMER_EXPIRED ,	 
 RSSI_SCAN_CNF_INVALID_REQUEST_PARAMS ,	 
 RSSI_SCAN_CNF_INVALID_L1_CONFIGURATION ,	 
 RSSI_SCAN_CNF_AUTO_ABORT_BY_HOST_L1 ,	 
 } plmRssiScanCnfCompleteStatus_te_enum;

typedef UINT8 plmRssiScanCnfCompleteStatus_te ;
//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 ...
 INT8 reserved2 ;	 
 // #endif	 
 plmRssiScanCnfCompleteStatus_te completeStatus ; /**< RSSI Scan completion status. When TRUE , the RSSI Scan completed successfully. When FASLE , the RSSI Scan failed */	 
 UINT16 numOfEarfcns ; /**< Number of reported EARFCNs. */	 
 UINT16 numOfUarfcns ; /**< Number of reported UARFCNs. */	 
 UINT16 numOfArfcns ; /**< Number of reported ARFCNs. */	 
 } plmRssiScanCnf_ts;

typedef UINT8 plmRssiScanAbortReq ;
typedef UINT8 plmRssiScanAbortCnf ;
...
typedef void ( *wgiBcchGsmDeactivateReq_t ) ( void ) ;
typedef void ( *wgiSetUtevStartBcchForWb_t ) ( GsmBcchDecodeReqDBInWb_ts *gsmBcchInfoDB ) ;
typedef void ( *wgiSetUtevUpdateBcchForWb_t ) ( GsmBcchDecodeReqDBInWb_ts *gsmBcchInfoDB_P , Int8 simID , initialRat_te rat ) ;
typedef void ( *wgiSetUtevUpdateBcchForWbInDSDS_t ) ( plwGsmMultiBcchDecodeReq_ts *gsmMultiBcchCellInfo ) ;
typedef void ( *wgiL1BgUmphMeasRadioReq_t ) ( UINT8 length ) ;
typedef void ( *wgiL1BgUmphRssiRadioReq_t ) ( void ) ;
typedef void ( *wgiL1BgUmphDetectedCellMeasInd_t ) ( interFreqCellMeasInd_ts * indication ) ;
typedef void ( *wgiL1BgUmphRssiPerUarfcnInd_t ) ( INT16 indication ) ;
typedef void ( *wgiL1BgUmphRssiScanInd_t ) ( rssi_reply_ts * gsmRssiResult ) ;
typedef void ( *wgiCellMeasIndPerUARFCN_t ) ( UtranCellMeasIndPerUarfcn *utranCellMeasIndPerUarfcn ) ;
typedef void ( *wgiL1BgUmphUtranAbortAck_t ) ( void ) ;
typedef void ( *wgiL1BgUmphUtranDetAbortAck_t ) ( void ) ;
typedef void ( *wgiGSMPowerup_t ) ( void ) ;
typedef void ( *wgiGSMInitStaticSharedMemory_t ) ( void ) ;
typedef void ( *wgiGSMReset_t ) ( void ) ;
typedef void ( *wgiGSMStartup_t ) ( Bool value ) ;
typedef void ( *wgiGSMTerminate_t ) ( Bool value ) ;
...
typedef void ( *wgiSaveGsmAFCValues_t ) ( void ) ;
typedef void ( *wgiAfcDacSaveValue_t ) ( UINT16 val ) ;
...
typedef void ( *wgiSetEventForBchDecodeTermination_t ) ( Bool UtranBchDecodeIndWasSent ) ;
typedef void ( *wgiResetUtranMeas_t ) ( void ) ;
...
typedef void ( *wgiSetResumeFlag_t ) ( UINT16 val ) ;
typedef UINT16 ( *wgiGetResumeFlag_t ) ( void ) ;
typedef plgMphDeactivateCnf_t ( *wgiRetreiveMphDeactivateCnf_t ) ( void ) ;
typedef void ( *wgiSetEventForPldGsmCnf_t ) ( void ) ;
...
typedef BOOL ( *DiagPSisRunningFn ) ( void ) ;
DIAG_FILTER ( DRAT , DEBUG , wgi_Bind_function2 , DIAG_ERROR)  
 diagTextPrintf ( " <<< WARNING >>> WB to GSM interface - Default bind function called <<< WARNING >>> " );

//PPC Version : V2.1.9.30
//PPL Source File Name : X:\tavor\Arbel\obj_PMD2NONE\prepass_results\egi_bind.ppp
//PPL Source File Name : X:\\drat\\GSM_IF\\src\\egi_bind.c
//PPC Version : V2.1.9.30
//PPL Source File Name : X:\tavor\Arbel\obj_PMD2NONE\prepass_results\l1cellularPowerApplication.ppp
//PPL Source File Name : X:\\drat\\CellularPowerApplication\\src\\l1cellularPowerApplication.c
typedef unsigned char BOOL ;
typedef unsigned char UINT8 ;
typedef unsigned short UINT16 ;
typedef unsigned long UINT32 ;
...
typedef volatile Int8 * McuInt8port_p ;
typedef volatile Int16 * McuInt16port_p ;
typedef volatile Int32 * McuInt32port_p ;
...
typedef Int8 NormalFilterMatrix [ 100 ] [ NUM_SIGNAL_BASES + 1 ] ;
typedef Int8 CompactFilterMatrix [ ( ( 100 / 8 ) + 1 ) * ( NUM_SIGNAL_BASES + 1 ) ] ;
typedef Int8 **TinyFilterMatrix ;
//ICAT EXPORTED ENUM 
 typedef enum SlowClockStateTag 
 {	 
 SLOW_CLOCK_INVALID_CAL_DATA = 0 ,	 
 SLOW_CLOCK_WAIT_FOR_FIRST_SNAP_INTERRUPT ,	 
 SLOW_CLOCK_FIRST_SNAP_COMPLETE ,	 
 SLOW_CLOCK_WAIT_FOR_SECOND_SNAP_INTERRUPT ,	 
 SLOW_CLOCK_ACQUIRE_REFERENCE_SNAP ,	 
 SLOW_CLOCK_WAIT_FOR_REFERENCE_SNAP_INTERRUPT ,	 
 SLOW_CLOCK_VALID_CAL_DATA_AND_REFERENCE ,	 
 SLOW_CLOCK_PREPARE_FOR_SLEEP ,	 
 SLOW_CLOCK_ON ,	 
 NUMBER_OF_SLOW_CLOCK_STATES	 
 } 
 SlowClockState;

typedef Int8 SleepState ;
//ICAT EXPORTED ENUM 
 enum SleepStateEnum 
 {	 
 SLEEP_IDLE = 0 ,	 
 SLEEP_LOAD_SLEEP_INSTRUCTION ,	 
 SLEEP_SORTER ,	 
 SLEEP_SORTER_SLEEP_ABORTED ,	 
 SLEEP_SLEEP_SWI ,	 
 SLEEP_SLEEP_SWI_SLEEP_ABORTED ,	 
 SLEEP_AFTER_WAKE ,	 
 SLEEP_WAKE_SWI ,	 
 SLEEP_WAKE_ENDLESS_SLEEP ,	 
 SLEEP_LOAD_FAST_SLEEP_INSTRUCTION ,	 
 SLEEP_FAST_SLEEP_SWI ,	 
 SLEEP_FAST_SLEEP_SWI_SLEEP_ABORTED ,	 
 SLEEP_FAST_SORTER ,	 
 SLEEP_STATE_INVALID	 
 };
...
typedef void ( * RspReadingCallbackBoth ) ( BOOL , int , int ) ;
//ICAT EXPORTED ENUM 
 typedef enum rfCalibFile_values 
 {	 
 NO_CALIB_FILE = 0 , // not found in NVM	 
 CALIB_FILE_IS_UPDATED , // NVM file found and alligned to code ' s version	 
 CALIB_FILE_IS_NOT_UPDATED , // NVM file found and was converted to be alligned to code ' s version	 
 CALIB_FILE_IS_NOT_UPDATED_USING_DEFAULTS // NVM file found , is not alligned to code ' s version and we ' re using defaults instead	 
 } rfCalibFile_te;
...
//ICAT EXPORTED STRUCT 
 ...
 {	 
 NVM_Header_ts nvmHeader ;	 
 rfCalibFile_te calibNvmStatus ;	 
 UINT8 pad [ 3 ] ;	 
 } rfCalibFileStatus_ts;

typedef UINT8 commDvfmPP_t ;
//ICAT EXPORTED ENUM 
 typedef enum 
 {	 
 PCCPCH_CH_REC_TYPE = 0 ,	 
 PICH_CH_REC_TYPE = 1 ,	 
 PRACH_CH_REC_TYPE = 2 ,	 
 SCCPCH_PCH_CH_REC_TYPE = 3 ,	 
 SCCPCH_FACH_CH_REC_TYPE = 4 ,	 
 DCH_CH_REC_TYPE = 5 ,	 
 HSDPA_CH_REC_TYPE = 6 ,	 
 HSUPA_CH_REC_TYPE = 7 ,	 
 CBS_CH_REC_TYPE = 8 ,	 
 ...
 RECEIVER_CH_TYPE_MAX // keep last	 
 } receiver_ch_te;

typedef UINT8 plCalibRxAgcDriverType_te ;
//ICAT EXPORTED ENUM 
 typedef enum 
 {	 
 VCTRL_OPTIMAL_UPDATE = 0 ,	 
 VCTRL_WC_UPDATE	 
 } digTxApcParamsVctrlDynUpdate_te;
...
//ICAT EXPORTED ENUM 
 ...
 PD_TBL_TYPE ,	 
 VCTRL_TBL_TYPE ,	 
 DIG_GENERAL_PARAMS_TBL_TYPE ,	 
 PGC_THR_TBL_TYPE , // -+ CQ00199632 22 -Jan-2012 +-	 
 TX_APC_HS_MAX_PWR_BACK_OFF // -+ CQ00199632 22 -Jan-2012 +-	 
 } digTxApcParamsTblType_te;

//ICAT EXPORTED ENUM 
 typedef enum 
 {	 
 DIG_TX_APC_PGC_CM0 = 0 ,	 
 DIG_TX_APC_PGC_CM0_2 ,	 
 DIG_TX_APC_PGC_CM2 ,	 
 DIG_TX_APC_PGC_TBL_NUM // 3 PGC tables	 
 } digTxApc_PgcCM_te;

//ICAT EXPORTED ENUM 
 typedef enum 
 {	 
 RFD_TX_APC_P_LINEAR_SCALE ,	 
 RFD_TX_APC_P_FLOORED_SCALE ,	 
 RFD_TX_APC_P_CEILED_SCALE	 
 } digTxApc_Pscaling_te;

//ICAT EXPORTED ENUM 
 typedef enum 
 {	 
 RFD_TX_APC_F_LINEAR_SCALE ,	 
 RFD_TX_APC_F_ROUNDING_SCALE ,	 
 } digTxApc_Fscaling_te;
...
//ICAT EXPORTED ENUM 
 ...
 DIG_TX_APC_PD_LG = 0 ,	 
 DIG_TX_APC_PD_HG ,	 
 DIG_TX_APC_PD_ZONE_NUM // 2 PD Zones	 
 } digTxApc_Pd_te;

//ICAT EXPORTED ENUM 
 typedef enum 
 {	 
 DIG_TX_APC_PA_SWITCH_COMP_LG = 0 ,	 
 DIG_TX_APC_PA_SWITCH_COMP_HG ,	 
 DIG_TX_APC_PA_SWITCH_COMP_NUM	 
 } digTxApc_PaSwitchComp_te;

//ICAT EXPORTED ENUM 
 typedef enum 
 {	 
 RFD_TX_APC_PGC_L1_TBL , // to delete L1 from te defenition	 
 RFD_TX_APC_PGC_CALIB_TBL ,	 
 RFD_TX_APC_VCTRL_LG_TBL ,	 
 RFD_TX_APC_VCTRL_HG_TBL ,	 
 RFD_TX_APC_VCTRL_CALIB_LG_TBL ,	 
 // RFD_TX_APC_VCTRL_CALIB_HG_TBL , // TBD	 
 RFD_TX_APC_PD_LG_TBL ,	 
 RFD_TX_APC_PD_HG_TBL ,	 
 RFD_TX_APC_PD_CALIB_LG_TBL ,	 
 RFD_TX_APC_PD_CALIB_HG_TBL	 
 } digTxApc_TableType_te;
...
//ICAT EXPORTED STRUCT 
 ...
 INT16 deltaCtrl ;	 
 INT16 deltaPower ;	 
 } digTxApcCtrlnPowerOutput_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 INT16 paLow2High ; // in Q0	 
 INT16 paHigh2Low ; // in Q0	 
 INT16 paPhaseCorrection ; // phase err correction	 
 INT16 paZoneStep ; // offset between H<->L	 
 } digTxApc_PaZoneSwitching_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 INT16 deltaVctrl4CM2_0 ; // Q0	 
 INT16 deltaVctrl4CM3_5 ; // Q0	 
 INT16 deltaVctrl4CalibCM2_0 ; // Q0 - David ' s upgrade I	 
 INT16 deltaVctrl4CalibCM3_5 ; // Q0 - David ' s upgrade I	 
 INT16 deltaVctrl_Dev_T_LG ; // Q8	 
 INT16 deltaVctrl_Dev_T_HG ; // Q8	 
 } digTxApc_VctrlComp_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 UINT16 vbatRef ; // Q0	 
 UINT16 olVbatComp ; // Q8	 
 digTxApc_AffectedAxis_te olVbatAffectedAxis ;	 
 UINT16 pad ;	 
 } digTxApc_OLCompVbat_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 UINT16 temperatureRef ; // Q8	 
 UINT16 olTemp_Fx [ 15 ] ; // Fx calib array - Q0	 
 INT16 olLGLHotTempCompTbl [ 15 ] ; // LGL Hot Temperature characterization slopes - Q8	 
 INT16 olLGLColdTempCompTbl [ 15 ] ; // LGL Cold Temperature characterization slopes - Q8	 
 INT16 olLGHHotTempCompTbl [ 15 ] ; // LGH Hot Temperature characterization slopes - Q8	 
 INT16 olLGHColdTempCompTbl [ 15 ] ; // LGH Cold Temperature characterization slopes - Q8	 
 INT16 olP_LGTh ;	 
 INT16 olP_LGH ;	 
 digTxApc_AffectedAxis_te olTempAffectedAxis ;	 
 UINT8 olTemp_FxNum ;	 
 UINT8 pad ;	 
 } digTxApc_OLCompTemperature_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 UINT16 olFreq_Fx [ 15 ] ; // Fx calib array- Q0	 
 INT16 olLGLFreqCompTbl [ 15 ] ; // LGL Freq ripple calibration - Q8	 
 INT16 olLGHFreqCompTbl [ 15 ] ; // LGH Freq ripple calibration - Q8	 
 INT16 olP_LGTh ;	 
 INT16 olP_LGH ;	 
 digTxApc_AffectedAxis_te olFreqAffectedAxis ;	 
 UINT8 olFreq_FxNum ;	 
 UINT8 pad [ 3 ] ;	 
 } digTxApc_OLCompFreqRipple_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 digTxApc_OLCompFreqRipple_ts txApcOLCompF ;	 
 digTxApc_OLCompTemperature_ts txApcOLCompT ;	 
 digTxApc_OLCompVbat_ts txApcOLCompV ;	 
 } digTxApc_OLComp_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 UINT16 clLGTemp_Fx [ 15 ] ; // Fx calib array - LowGain - Q0	 
 INT16 clLGLHotTempCompTbl [ 15 ] ; // LGL Hot Temperature characterization slopes LowGain - Q8	 
 INT16 clLGLColdTempCompTbl [ 15 ] ; // LGL Cold Temperature characterization slopes LowGain - Q8	 
 INT16 clLGHHotTempCompTbl [ 15 ] ; // LGH Hot Temperature characterization slopes LowGain - Q8	 
 INT16 clLGHColdTempCompTbl [ 15 ] ; // LGH Cold Temperature characterization slopes LowGain - Q8	 
 INT16 clP_LGTh ;	 
 INT16 clP_LGH ;	 
 UINT16 clHGTemp_Fx [ 15 ] ; // Fx calib array - HighGain - Q0	 
 INT16 clHGLHotTempCompTbl [ 15 ] ; // Hot Temperature characterization slopes HighGainLow - Q8	 
 INT16 clHGLColdTempCompTbl [ 15 ] ; // Cold Temperature characterization slopes HighGainLow - Q8	 
 INT16 clHGHHotTempCompTbl [ 15 ] ; // Hot Temperature characterization slopes HighGainHigh - Q8	 
 INT16 clHGHColdTempCompTbl [ 15 ] ; // Cold Temperature characterization slopes HighGainHigh - Q8	 
 INT16 clP_HGTh ;	 
 INT16 clP_HGH ;	 
 digTxApc_AffectedAxis_te clTempAffectedAxis ;	 
 UINT8 clLGTemp_FxNum ;	 
 UINT8 clHGTemp_FxNum ;	 
 } digTxApc_CLCompTemperature_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 UINT16 clLGFreq_Fx [ 15 ] ; // Fx calib array - LowGain - Q0	 
 INT16 clLGLFreqCompTbl [ 15 ] ; // LGLFreq ripple calibration - LowGain - Q8	 
 INT16 clLGHFreqCompTbl [ 15 ] ; // LGH Freq ripple calibration - LowGain - Q8	 
 INT16 clP_LGTh ;	 
 INT16 clP_LGH ;	 
 UINT16 clHGFreq_Fx [ 15 ] ; // Fx calib array - HighGain - Q0	 
 INT16 clHGLFreqCompTbl [ 15 ] ; // Freq ripple calibration - HighGainLow - Q8	 
 INT16 clHGHFreqCompTbl [ 15 ] ; // Freq ripple calibration - HighGainHigh - Q8	 
 INT16 clP_HGTh ;	 
 INT16 clP_HGH ;	 
 digTxApc_AffectedAxis_te clFreqAffectedAxis ;	 
 UINT8 clLGFreq_FxNum ;	 
 UINT8 clHGFreq_FxNum ;	 
 } digTxApc_CLCompFreqRipple_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 digTxApc_CLCompFreqRipple_ts txApcCLCompF ;	 
 digTxApc_CLCompTemperature_ts txApcCLCompT ;	 
 } digTxApc_CLComp_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 UINT16 vctrlHG_l1Tbl [ ( 14 / 1 + 1 ) ] ; // Vctrl vs. Pout HG - Q0	 
 UINT16 vctrlHG_calibTbl [ ( ( ( 14 + ( 2 *6 ) ) / 1 + 1 ) ) ] ; // Vctrl vs. Pout HG - calibration table - Q0	 
 } digTxApc_VctrlHG_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 UINT16 vctrlLG_l1Tbl [ DIG_TX_APC_PGC_TBL_NUM ] [ ( ( ( 14 / 1 ) + ( 20 / 2 ) +1 ) ) ] ; // Vctrl vs. Pout LG - Q0 - David ' s upgrade I	 
 UINT16 vctrlLG_calibTbl [ ( ( ( ( 14 +6 ) / 1 ) + ( 20 / 2 ) +1 ) ) ] ; // Vctrl vs. Pout LG - calibration table - Q0	 
 } digTxApc_VctrlLG_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 digTxApc_VctrlLG_ts vctrlLG ;	 
 digTxApc_VctrlHG_ts vctrlHG ;	 
 } digTxApc_VctrlMain_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
	 
 UINT16 pdLG_l1Tbl [ ( 14 / 1 + 1 ) ] ; // PD vs. Pout LG - Q5	 
 UINT16 pdLG_calibTbl [ ( ( ( 14 +6 ) / 1 + 1 ) ) ] ; // PD vs. Pout LG - calibration table - Q5	 
 } digTxApc_PdLG_ts;
...
//ICAT EXPORTED STRUCT 
 ...
 UINT16 pdHG_l1Tbl [ ( 14 / 1 + 1 ) ] ; // PD vs. Pout HG - Q5	 
 UINT16 pdHG_calibTbl [ ( ( ( 14 + ( 2 *6 ) ) / 1 + 1 ) ) ] ; // PD vs. Pout HG - calibration table - Q5	 
 } digTxApc_PdHG_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 digTxApc_PdLG_ts pdLG ;	 
 digTxApc_PdHG_ts pdHG ;	 
 UINT16 pdSlopeLG [ ( 14 / 1 + 1 ) ] ; // dPD / dP vs. Pout LG - Q8	 
 UINT16 pdSlopeHG [ ( 14 / 1 + 1 ) ] ; // dPD / dP vs. Pout HG - Q8	 
 } digTxApc_CLMain_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 UINT16 pgc_l1Tbl [ ( ( ( 14 / 1 ) + ( 58 / 2 ) +1 ) ) ] ; // PGC vs. Pout - Q0	 
 UINT16 pgc_calibTbl [ ( ( ( ( 14 +6 ) / 1 ) + ( ( 58 +6 ) / 2 ) +1 ) ) ] ; // PGC vs. Pout - calibration table - Q0	 
 UINT16 pgcSlope_l1Tbl [ ( ( ( 14 / 1 ) + ( 58 / 2 ) +1 ) ) ] ; // dPGC / dP vs. Pout - Q8	 
 UINT16 pgcSlope_calibTbl [ ( ( ( ( 14 +6 ) / 1 ) + ( 58 / 2 ) + 1 ) ) ] ; // dPGC / dP vs. Pout - calibration table - Q8	 
 } digTxApc_PGC_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 digTxApc_PGC_ts pgc [ DIG_TX_APC_PGC_TBL_NUM ] ; // PGC settings for CM = 0 , 0 ..2 , 2 +	 
 } digTxApc_OLMain_ts;
...
//ICAT EXPORTED STRUCT 
 ...
 INT16 pMaxLG ; // Q8	 
 INT16 pMinHG ; // Q8	 
 INT16 pMaxHG_Norm [ 15 ] ; // Q8	 
 INT16 pMaxHG_Extr [ 15 ] ; // Q8	 
 } digTxApc_PowerRanges_ts;
...
//ICAT EXPORTED STRUCT 
 ...
 UINT16 tempExtr ; // Q8	 
 UINT16 vBatExtr ; // Q8	 
 } digTxApc_LoopAccuracies_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 digTxApc_PaZoneSwitching_ts txApcZoneSwitch ;	 
 digTxApc_VctrlComp_ts txApcVctrlComp ;	 
 digTxApc_OLComp_ts txApcOlComp ;	 
 digTxApc_CLComp_ts txApcClComp ;	 
 digTxApc_OLMain_ts txApcOL ;	 
 digTxApc_CLMain_ts txApcCL ;	 
 digTxApc_VctrlMain_ts txApcVctrl ;	 
 digTxApc_PowerRanges_ts txPowerRanges ;	 
 digTxApc_LoopAccuracies_ts txLoopAccuracies ;	 
 UINT16 txApcOLThrLUT [ ( 9 ) ] ;	 
 UINT16 txApcPdOffset [ DIG_TX_APC_PD_ZONE_NUM ] ; // Q5	 
 UINT16 txApcPaSwitchComp [ DIG_TX_APC_PA_SWITCH_COMP_NUM ] ; // Q8 2 ' s comp.	 
 UINT16 txApcHsMaxPwrBackOff ; // Q8 2 ' s comp	 
 } digTxApc_MainOneBand_ts;

//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
 digTxApc_MainOneBand_ts digTxApc [ ( 5 ) ] ;	 
 } digTxApc_Main_ts;
...
//ICAT EXPORTED ENUM 
 typedef enum 
 {	 
 VCTCXO_AFC_CONTROL = 0 , // default	 
 DCXO_AFC_CONTROL ,	 
 AFC_CONTROL_UNKNOWN_TYPE	 
 } AFC_Control_te;
...
//ICAT EXPORTED ENUM 
 typedef enum 
 {	 
 TX_APC_MAX_POWER_UPDATED_BY_DPCH ,	 
 TX_APC_MAX_POWER_UPDATED_BY_PRACH ,	 
 TX_APC_MAX_POWER_UPDATED_BY_TEMPERATURE	 
 } RFD_TxApcUpdateMaxPowerTrigger_te;
...
DIAG_FILTER ( DRAT , CP_APP , CellularPowerAppInit1 , DIAG_INFORMATION)  
 diagPrintf ( " CellularPowerAppInit: G_enableD2InWb=%d " , G_enableD2InWb );

DIAG_FILTER ( CP_APP , AAM_API , CellularPowerAppStateChange1 , DIAG_INFORMATION)  
 diagPrintf ( " CellularPowerAppStateChange. statePanding=%d , wakeupTime:0x%lx , M_GetCellularPowerAppState ( ) =%d , RAT0=%d , RAT1=%d " , 
 statePanding , wakeuptime , cellularPowerAppState , gwiL1GetRAT ( 0 ) , gwiL1GetRAT ( 1 ) );

DIAG_FILTER ( CP_APP , AAM_API , L1CEnableD2Entry , DIAG_INFORMATION)  
 diagPrintf ( " L1CEnableD2Entry was called. enable: %d , wakeuptime: %lx , M_GetCellularPowerAppState ( ) =%d " , 
 isEnableD2 , wakeuptime , cellularPowerAppState );

DIAG_FILTER ( CP_APP , AAM_API , L1CSetRat , DIAG_INFORMATION)  
 diagPrintf ( " L1CSetRat was called , newRat: %d , M_GetCellularPowerAppState ( ) =%d " , newRat , cellularPowerAppState );

//ICAT EXPORTED FUNCTION_FILTER_DUMMY - CP_APP , D2EXIT , CellularPowerAppD2Recovery 
 void CellularPowerAppD2Recovery ( PM_PowerStatesE stateexited , BOOL b_DDR_ready , BOOL b_RegsRetainedState ) 
 {	 
 // PM_EXT_DBG_EVENT_SEND ( PM_EXT_DBG_EVENT_GSM_WAKEUP_SWI , 0x30 ) ;	 
	 
	 
	 
	 
	 
 switch ( cellularPowerAppState )	 
 {		 
 case CPA_GSM_DRX :		 
 case CPA_GSM_OOS :		 
 break ;		 
		 
 // in WB / LTE cases , setting if rfContMux to its correct value is done by restoring this register		 
 // to its value before d2 , which is done in DSP level		 
 case CPA_WCDMA_DRX :		 
 case CPA_LTE_DRX :		 
 {			 
 ...
 case CPA_NO_ACTIVE_RAT :		 
 {			 
 // curentlly nothing to do			 
 }		 
 break ;		 
 ...
 /* Raviv debug 16 / 4 / 6 : Notify poision. */	 
 ;	 
	 
 return ;	 
 }

//ICAT EXPORTED FUNCTION_FILTER_DUMMY - CP_APP , WAKEUP , CellularPowerAppRMWBSMWakeupCallback 
 void CellularPowerAppRMWBSMWakeupCallback ( PM_PowerStatesE sleepstate , PM_PowerStatesE WUState , BOOL b_DDR_ready , BOOL b_RegsRetainedState ) 
 {	 
 ...
 INTCClear ( INTC_LTE_TD_WB_WAKE_UP ) ;	 
 INTCDisable ( INTC_LTE_TD_WB_WAKE_UP ) ;	 
 ...
 UINT16 plpBuf = 0 ;	 
 // memset ( ( UINT8 * ) plpBuf , 0 , sizeof ( UINT16 ) ) ;	 
	 
 // send 0x126 Cmd to wake MSA	 
 IPC_Command tmpCmdToSend ;	 
 tmpCmdToSend.opCode = PLP_DISABLE_MSA_POWER_DOWN_OPCODE ;	 
 tmpCmdToSend.cmdLength = sizeof ( UINT16 ) / 2 ; ;	 
 // tmpCmdToSend.cmdData = NULL ;	 
 tmpCmdToSend.cmdData = &plpBuf ;	 
	 
	 
 if ( IPCCommCommandSend ( &tmpCmdToSend , CP_APP_APPLICATION_ID ) != IPC_RC_AVAILABLE )	 
 {		 
 { } ;		 
 }	 
 ...
 AAMManage ( aamHandle_GSM_UMTS , AAM_APP_BUSY , 0 , ( UINT32 ) ( 0xFFFFFFFF ) ) ;	 
	 
	 
	 
 // DIAG_FILTER ( CP_APP , AAM_API , CellularPowerAppRMWBSMWakeupCallback , DIAG_INFORMATION )	 
 // diagPrintf ( " CellularPowerAppRMWBSMWakeupCallback was called " ) ;	 
 ;	 
 }

//ICAT EXPORTED FUNCTION_FILTER_DUMMY - CP_APP , WAKEUP , CellularPowerAppRMWBSMWakeup 
 void CellularPowerAppRMWBSMWakeup ( void ) 
 {	 
...
//ICAT EXPORTED FUNCTION_FILTER_DUMMY - CP_APP , WAKEUP , CellularPowerAppLteWakeup 
 void CellularPowerAppLteWakeup ( void ) // dong 
 {	 
 INTCClear ( INTC_LTE_TD_WB_WAKE_UP ) ;	 
 INTCDisable ( INTC_LTE_TD_WB_WAKE_UP ) ;	 
	 
 AAMManage ( aamHandle_LTE , AAM_APP_BUSY , 0 , ( UINT32 ) ( 0xFFFFFFFF ) ) ;	 
...
DIAG_FILTER ( CP_APP , drat , CPASendIMLSettingToDSP_1 , DIAG_INFORMATION)  
 diagPrintf ( " Send DSP log setting to DSP , IMLConfigType:%d " , imlSetting.IMLConfigVal );

DIAG_FILTER ( L1C , l1cdrat , CPASendIMLSettingToDSP_2 , DIAG_INFORMATION)  
 diagPrintf ( " L1C failed to send DSP log setting to DSP " );

//ICAT EXPORTED FUNCTION_FILTER_DUMMY - CP_APP , PowerMagamger , SendPowerManamgerConfigToDSP 
 void CPASendPowerManamgerConfigToDSP ( INT8 PowerManagementEnabled , INT8 ucVcxoStableTime , INT8 ucPllStableTime , INT8 ucClkGenTime ) 
 {	 
 ...
 /*	 
 Word #0	 
 bit0: Power Manamge Control:	 
 1 : PM Enabled	 
 0 : PM disabled	 
 bit1-7: reserved	 
 bit8-15: ucVcxoStableTime	 
 Word #1	 
 bit0-7: ucPllStableTime	 
 bit8-15: ucClkGenTime	 
 Word #2	 
 value ( 0 ) - VENDOR_SPECIFIC_INFO_NULL 0	 
 bit2 - VENDOR_SPECIFIC_INFO_RRM RRM Specific Features Enabled by Default	 
 bit3 - VENDOR_SPECIFIC_INFO_MTNET MTNET Specific Features Enabled by Default	 
 Word #3	 
 HSL status	 
 Word #4	 
 DualCarrierFlag	 
 ...
 */	 
 ...
 dataBuf [ 0 ] = ( ucVcxoStableTime << 8 ) | PowerManagementEnabled ;	 
 dataBuf [ 1 ] = ( ucClkGenTime << 8 ) | ucPllStableTime ;	 
 dataBuf [ 2 ] = ( Int16 ) ( ( systemcNvmParams.vendorSpecificInfo ) & 0xfc ) ; /* To indicate test modes to L1 */	 
 /*CQ00079199 begin*/	 
 // dataBuf [ 3 ] = ( Int16 ) ( GetHslStatus ( ) ) ;	 
 dataBuf [ 3 ] = 0 ;	 
 /*CQ00079199 end*/	 
 /* CQ00013132: modified by htfeng: 2011.090000 .14: begin */	 
 dataBuf [ 4 ] = ( Int16 ) ( GetDualCarrierCfg ( ) ) ;	 
 dataBuf [ 5 ] = ( Int16 ) ( GetDualAntCfg ( ) ) ;	 
 /* CQ00031247 - begin */	 
 dataBuf [ 6 ] = ( Int16 ) 0 ;	 
 /* CQ00031247 - end */	 
 // dataBuf [ 6 ] = ( Int16 ) abmmGetIsLteDualLink ( ) ;	 
 /*CQ00079199 begin*/	 
 // dataBuf [ 7 ] = ( Int16 ) ( GetIML2DDRStatus ( ) ) ;	 
 dataBuf [ 7 ] = 0 ;	 
 /*CQ00079199 end*/	 
 len = 8 ;	 
 /* CQ00013132: modified by htfeng: 2011.090000 .14: end */	 
	 
 cmd.opCode = CP_DSP_POWERMANAGER_CONFIG_OPCODE ; // 0xee - also takes some important system Nvm Parameters	 
 cmd.cmdLength = len ;	 
 cmd.cmdData = dataBuf ;	 
	 
DIAG_FILTER ( CP_APP , drat , SendPowerManamgerConfigToDSP_1 , DIAG_INFORMATION)  
 diagPrintf ( " SendPowerManamgerConfigToDSP: Enable 0x%x Vcxo 0x%x Pll 0x%x ClkGen 0x%x TestMode 0x%x " , PowerManagementEnabled , ucVcxoStableTime , ucPllStableTime , ucClkGenTime , dataBuf [ 2 ] );

	 
	 
DIAG_FILTER ( CP_APP , drat , L1cSendPowerManamgerConfigToDSP_2 , DIAG_INFORMATION)  
 diagStructPrintf ( " PowerManamgerConfig to DSP: " , ( void* ) dataBuf , 2 *len );

	 
	 
	 
 /* Send the PLP command: */	 
 if ( IPCCommCommandSend ( &cmd , CP_APP_APPLICATION_ID ) != IPC_RC_AVAILABLE )	 
 {		 
DIAG_FILTER ( L1C , l1cdrat , L1cSendPowerManamgerConfigToDSP_3 , DIAG_INFORMATION)  
 diagPrintf ( " L1C failed to send power management control enable IPC , PowerManagementEnabled: %x " , PowerManagementEnabled );

		 
 }	 
	 
 CPASendDspLogSettingToDSP ( ) ; // CQ00079199	 
...
DIAG_FILTER ( L1C , l1cdrat , CPASendSulogConfigToDSP_1 , DIAG_INFORMATION)  
 diagPrintf ( " L1C failed to send Sulog Configuration. " );

DIAG_FILTER ( CP_APP , AAM_API , CellularPowerAppExitFromOos1 , DIAG_INFORMATION)  
 diagPrintf ( " CellularPowerAppExitFromOos. M_GetCellularPowerAppState ( ) =%d " , cellularPowerAppState );

DIAG_FILTER ( APLP , AM , l1GsmCheckDisableD2inSetGsmSimb , DIAG_INFORMATION)  
 diagTextPrintf ( " l1GsmCheckDisableD2inSetGsmSimb " );

DIAG_FILTER ( APLP , AM , l1GsmCheckEnableD2inSetGsmSimb , DIAG_INFORMATION)  
 diagTextPrintf ( " l1GsmCheckEnableD2inSetGsmSimb " );

//ICAT EXPORTED FUNCTION_FILTER_DUMMY - CP_APP , enableDisable , enableD2InWb 
 void enableD2InWb ( ) 
 {	 
 G_enableD2InWb = 1 ;	 
 }

//ICAT EXPORTED FUNCTION_FILTER_DUMMY - CP_APP , enableDisable , disableD2InWb 
 void disableD2InWb ( ) 
 {	 
 G_enableD2InWb = 0 ;	 
 }

//ICAT EXPORTED FUNCTION_FILTER_DUMMY - CP_APP , enableDisable , enableCpaFunc 
 void enableCpaFunc ( ) 
 {	 
DIAG_FILTER ( CP_APP , enableDisable , enableCpaFunc , DIAG_INFORMATION)  
 diagTextPrintf ( " enableCpaFunc " );

	 
 G_enableCpaFunc = 1 ;	 
 }

//ICAT EXPORTED FUNCTION_FILTER_DUMMY - CP_APP , enableDisable , disableCpaFunc 
 void disableCpaFunc ( ) 
 {	 
DIAG_FILTER ( CP_APP , enableDisable , disableCpaFunc , DIAG_INFORMATION)  
 diagPrintf ( " disableCpaFunc - disregarded " );
...
//PPC Version : V2.1.9.30
//PPL Source File Name : X:\tavor\Arbel\obj_PMD2NONE\prepass_results\drat_coma_bsp_adap.ppp
//PPL Source File Name : X:\\drat\\COMA\\src\\drat_coma_bsp_adap.c
typedef unsigned char BOOL ;
typedef unsigned char UINT8 ;
typedef unsigned short UINT16 ;
typedef unsigned long UINT32 ;
...
typedef void ( *IPCCommSpyCommandNotification ) ( UINT16 , UINT16 , UINT8* , SpyCmdData* ) ;
typedef void ( *IPCErrorIndicationCallBack ) ( IPC_ERROR_INDICATION * ) ;
DIAG_FILTER ( HAL , IPC , ARM_WRITE_HANDSHAKE , DIAG_INFORMATION)  
 diagPrintf ( " Arbel write to MSA IPC GP Register " );

//PPC Version : V2.1.9.30
//PPL Source File Name : X:\tavor\Arbel\obj_PMD2NONE\prepass_results\drat_coma_power_adap.ppp
//PPL Source File Name : X:\\drat\\COMA\\src\\drat_coma_power_adap.c
typedef unsigned char BOOL ;
typedef unsigned char UINT8 ;
typedef unsigned short UINT16 ;
typedef unsigned long UINT32 ;
...
//ICAT EXPORTED ENUM 
 typedef enum {	 
 DRAT_COMA_VOTING_MUX_TO_GSM = 0 ,	 
 DRAT_COMA_VOTING_MUX_TO_WB = 1 ,	 
 DRAT_COMA_VOTING_MUX_MAX	 
 } dratComaVotingMux_te;
