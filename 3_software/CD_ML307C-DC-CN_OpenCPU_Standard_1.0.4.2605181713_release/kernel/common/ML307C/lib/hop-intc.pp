...
//PPL Source File Name : X:\tavor\Arbel\obj_PMD2NONE\prepass_results\intc_xirq.ppp
//PPL Source File Name : X:\\hop\\intc\\src\\intc_xirq.c
...
typedef short Int16 ;
//PPC Version : V2.1.9.30
//PPL Source File Name : X:\tavor\Arbel\obj_PMD2NONE\prepass_results\intc_memRetain.ppp
//PPL Source File Name : X:\\hop\\intc\\src\\intc_memRetain.c
typedef unsigned char BOOL ;
typedef unsigned char UINT8 ;
typedef unsigned short UINT16 ;
typedef unsigned long UINT32 ;
