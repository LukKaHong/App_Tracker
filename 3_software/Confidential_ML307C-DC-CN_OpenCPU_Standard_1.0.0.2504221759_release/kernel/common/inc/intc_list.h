...
///////////////////xIRQ HW begin ///////////////////////////////
	...
	INTC_HW_GPB_ECIPHER  ,       /* HW IRQ [41] */  //INTC_SRC_CIPHER, INTC_HW_ECIPHER
	INTC_HW_DTC_CH0,             /* HW IRQ [42] */
	INTC_LTE_TX_TIME,                         /* HW IRQ [43] */
	INTC_HW_DTC_CH1,             /* HW IRQ [44] */
	INTC_HW_APB_ECIPHER,         /* HW IRQ [45] */  //INTC_SRC_CIPHER, INTC_HW_ECIPHER
	INTC_LTE_RX_TIME,                         /* HW IRQ [46] */
	INTC_HW_DTC_ERROR,           /* HW IRQ [47] */
	INTC_HW_SDIO,                /* HW IRQ [48] */  //INTC_CI2C_SCL_SDA_WAKE_UP
	INTC_GSM_WAKE_UP,            /* HW IRQ [49] */
	INTC_WBCDMA_WAKE_UP,    INTC_LTE_WAKE_UP = INTC_WBCDMA_WAKE_UP,INTC_TDCDMA_WAKE_UP = INTC_LTE_WAKE_UP,     /* HW IRQ [50] */
	INTC_CRXD_WAKE_UP,                        /* HW IRQ [51] */
	INTC_CGPIO_WAKE_UP,                       /* HW IRQ [52] */
	INTC_AP_ICU_SRC_3,                        /* HW IRQ [53] */
	INTC_GSSP_1_WAKE_UP,                      /* HW IRQ [54] */
	INTC_AP_ICU_SRC_4, INTC_SRC_USB_EDEN = INTC_AP_ICU_SRC_4, /* HW IRQ [55] */
	INTC_I2C_WAKE_UP,                         /* HW IRQ [56] */
	INTC_HW_COMM_UART, INTC_COMM_UART = INTC_HW_COMM_UART, /* HW [57] Comm UART Interrupt*/
	INTC_LTE_Z3_WAKE_UP,            /* HW IRQ [58] */
	INTC_AC_IPC_0,               /* HW IRQ [59] AC - IPC [0]*/
...
///////////////////xIRQ HW begin ///////////////////////////////
	INTC_SRC_ARM_DMA  = FIRST_HW_INT,         /* HW IRQ [0] */
	INTC_IPC_SRV0_CP,         /* HW IRQ [1] */
#if 0
	INTC_HW_RESERVED0,         /* HW IRQ [2] */
	INTC_HW_RESERVED1,         /* HW IRQ [3] */
	INTC_HW_RESERVED2,         /* HW IRQ [4] */
#else
	INTC_HW_XIRQ_CP_TIMER0,		   /* HW IRQ [2] */
	INTC_HW_XIRQ_CP_TIMER1,		   /* HW IRQ [3] */
	INTC_HW_XIRQ_CP_TIMER2,		   /* HW IRQ [4] */
#endif
	INTC_HW_RESERVED3,         /* HW IRQ [5] */
	INTC_HW_RESERVED4,         /* HW IRQ [6] */
	INTC_HW_RESERVED5,         /* HW IRQ [7] */
	INTC_HW_DMA_C2_0,         /* HW IRQ [8] */
	INTC_HW_DMA_C2_1,         /* HW IRQ [9] */
	INTC_HW_DMA_C2_2,         /* HW IRQ [10] */
	INTC_HW_DMA_C2_3,         /* HW IRQ [11] */
	...
	INTC_HW_Tmr1     ,        /* HW IRQ [36] Timer1 */
	INTC_HW_Tmr2     ,        /* HW IRQ [37] Timer2 */
	INTC_HW_RESERVED8 ,        /* HW IRQ [38] */
	INTC_HW_Tmr3 , INTC_HW_Tmr3BkUp = INTC_HW_Tmr3,        /* HW IRQ [39] Timer3 */
	INTC_HW_TmrWDT   ,        /* HW IRQ [40] Timer Watch Dog */
	INTC_HW_GPB_ECIPHER  ,       /* HW IRQ [41] */  //INTC_SRC_CIPHER, INTC_HW_ECIPHER
	INTC_HW_DTC_CH0,             /* HW IRQ [42] */
	INTC_HW_PERFORMANCE_MONITOR, /* HW IRQ [43] */
	INTC_HW_DTC_CH1,             /* HW IRQ [44] */
	INTC_HW_APB_ECIPHER,         /* HW IRQ [45] */  //INTC_SRC_CIPHER, INTC_HW_ECIPHER
	INTC_HW_C1_ARM_ERROR,        /* HW IRQ [46] */
	INTC_HW_DTC_ERROR,           /* HW IRQ [47] */
	INTC_HW_SDIO,                /* HW IRQ [48] */  //INTC_CI2C_SCL_SDA_WAKE_UP
	INTC_GSM_WAKE_UP,            /* HW IRQ [49] */
	INTC_WBCDMA_WAKE_UP,    INTC_LTE_WAKE_UP = INTC_WBCDMA_WAKE_UP,     /* HW IRQ [50] */
	INTC_TDCDMA_WAKE_UP = INTC_LTE_WAKE_UP,
	INTC_HW_GPIO_CP,             /* HW IRQ [51] */
	INTC_HW_RESERVED9,            /* HW IRQ [52] */
	INTC_HW_DSSP1,               /* HW IRQ [53] */
	INTC_HW_RESERVED10,            /* HW IRQ [54] */
	INTC_HW_DSSP3,               /* HW IRQ [55] */
	INTC_HW_RESERVED11,            /* HW IRQ [56] */
	INTC_HW_COMM_UART, INTC_COMM_UART = INTC_HW_COMM_UART, /* HW [57] Comm UART Interrupt*/
	INTC_LTE_Z3_WAKE_UP,            /* HW IRQ [58] */
	INTC_AC_IPC_0,               /* HW IRQ [59] AC - IPC [0]*/
	INTC_HW_RESERVED,             /* HW IRQ [60] */
	INTC_AC_IPC_1,               /* HW IRQ [61] AC - IPC [1]*/
	INTC_AC_IPC_2,               /* HW IRQ [62] AC - IPC [2]*/
	INTC_AC_IPC_3,               /* HW IRQ [63] AC - IPC [2]*/
///// XIRQ HW end //////////////////////////////////////
 ...
 */
    ...
    INTC_SRC_GPIO_0_DUMMY = MAX_INTERRUPT_CONTROLLER_SOURCES,INTC_GPIO_SRC_START_PIN=INTC_SRC_GPIO_0_DUMMY,
    INTC_SRC_GPIO_1_DUMMY,
#else
	// Other implementations do not have directly wired GPIO #0 and #1 - normal entries below
	INTC_SRC_GPIO_0 = MAX_INTERRUPT_CONTROLLER_SOURCES,INTC_GPIO_SRC_START_PIN=INTC_SRC_GPIO_0,
       INTC_SRC_GPIO_1,
#endif
#else
#if defined(INTC_GPIO_01_WIRED_TO_ICU)
...
//
#if defined(PHS_SW_DEMO_TTC) //20080828
//--------- ICU interrupt source --------------------------------------
		INTC_SRC_XIRQ = INTC_MAX_PRIMARY_INTERRUPT_SOURCES,  /*HW ICU[0] */ /* GSM Interrupt Controller *//* isrSource 173*/
		...
		INTC_SRC_USB,                       // USB1.1 (PHY)   /*HW ICU[44] */ /* isrSource 217*/
		...
		INTC_SRC_ICU_RESERVED9, //INTC_SRC_AP_PMU,                             /*HW ICU[60] *//* isrSource 233 */
		...
		INTC_SRC_M1_IPC_GNSS2TOP_WAKE = INTC_MAX_PRIMARY_INTERRUPT_SOURCES+119,
		INTC_SRC_M1_GNSS_WAKEUP_HOST_INT  = INTC_MAX_PRIMARY_INTERRUPT_SOURCES+120,
