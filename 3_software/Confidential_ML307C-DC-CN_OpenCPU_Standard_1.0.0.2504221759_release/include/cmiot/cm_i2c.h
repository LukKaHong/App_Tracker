...
#define    CM_I2C_CLK_HS_KHZ          1 /*特定值，表示从节点传输速率为 3.4 Mbps 或主节点传输速率为 3.3 Mbps。不进行高速传输时为标准模式。(暂不支持) */
#define    CM_I2C_CLK_HS_FAST_KHZ     2 /*特定值，表示从节点传输速率为 3.4 Mbps 或主节点传输速率为 3.3 Mbps。不进行高速传输时为快速模式。(暂不支持) */
