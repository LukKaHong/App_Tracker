...
typedef enum
{
    ...
    CM_FOTA_TYPE_HTTP,
    CM_FOTA_TYPE_HTTPS,
    CM_FOTA_TYPE_DATAMODE,             /*!< 不支持 */
    CM_FOTA_TYPE_FILESYSTEM_CUSTOM     /*!< 不支持 */
} cm_fota_url_type_e;
...
typedef struct
{
    ...
    char username[CM_FOTA_STRING_LEN];   /*!< 用户名，ML307C模组不支持*/
    char passwd[CM_FOTA_STRING_LEN];     /*!< 密码，ML307C模组不支持 */
