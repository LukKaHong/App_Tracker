...
int cm_async_dns_request_ex(const char *host_name, cm_async_dns_addrtype_e addr_type,
...
int cm_get_ipv4v6_local_addr(int cid, int sa_family, void *loc_sock_address);
int cm_get_active_cid(void);
#undef EXTERN
#ifdef __cplusplus
}
#endif
