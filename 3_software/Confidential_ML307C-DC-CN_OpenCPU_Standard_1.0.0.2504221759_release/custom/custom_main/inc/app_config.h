...
/* ===================================================================
 * 5.1 LBS 基站定位（GPS 超时回退，OneOSPOS 平台）
 *     OneOSPOS 为中移物联网自有定位平台，返回 GCJ02 坐标，
 *     端侧转 WGS84 后上报，与 GPS 坐标系统一。
 * =================================================================== */
#define APP_LBS_ENABLED             1
#define APP_LBS_PID                  "4XQ64asSb9"   /* OneLink 平台申请的 pid */
#define APP_LBS_TIMEOUT_MS          (15000)          /* LBS 请求超时 15 秒 (0-60s) */
#define APP_LBS_NEARBTS_ENABLE      0               /* 是否启用邻区基站：0 否 1 是 */
